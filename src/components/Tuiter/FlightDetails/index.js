            ...
            <div className="container wd-fg-color-white  card p-5 mt-5 wd-blueBG">
                <div className="row mt-2">
                    <div className="col-2 ps-3 me-3" style={{width:'100%'}}>
                        <label className="wd-fg-color-white h5 fw-bold">{flightDetails.legs[0].carriers.marketing[0].name}&nbsp;</label>
                ...
                <div className= "border-top border-secondary">
                    <Link to="/login">
                        <button className="btn-primary rounded-pill mt-3">Book</button>
                    </Link>
                </div>
            </div>
        </>
