                ...
                <div className="container  wd-fg-color-white  card p-5 mt-5 wd-blueBG">
                    <div className="row mt-2">
                        <div className="col-2 ps-3 me-3" style={{width: '100%'}}>
                            <label
                                className="wd-fg-color-white h5 fw-bold">{flightDetails.legs[0].carriers.marketing[0].name}&nbsp;</label>
                            <label
                                className="wd-topic wd-fg-color-white">&nbsp; {flightDetails.legs[0].segments[0].flightNumber}</label>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-4">
                            <b className="wd-fg-color-white">{flightDetails.legs[0].origin.name}({flightDetails.legs[0].origin.displayCode})</b></div>
                        <div className="col-2">
                    ...
                    <div className="border-top border-secondary">
                        <Link to="/login">
                            <button className="btn-primary rounded-pill mt-2">Book</button>
                        </Link>
                    </div>
                </div>
                    <br/>
        ...
        return (
            <>
                ...
                <div className="container wd-fg-color-white  card p-5 mt-5 wd-blueBG">
                    ...
                    <div className="border-top border-secondary">
                            <button className="btn-primary rounded-pill mt-2" onClick={submitted}>Book</button>
                    </div>
                </div>
